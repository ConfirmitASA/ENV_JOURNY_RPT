...
static var TextLibrary = {
    ...
    Page_Categorical_: { 9: 'Categorical', 20: 'TBD'},
    ...
    Page_Wordclouds_description: { 9: 'TBD', 20: 'TBD'},
    ...
    Page_Categorical_ScrollUpToCardText: { 9: 'Move up to the related card', 20: 'TBD'},
    ...
    Page_KPI_Trend: { trendTitle: {9: '', 20: ''}},
    Page_Trends_Trend: { trendTitle: {9: '', 20: ''} }
}
}
