...
//  
  ...
  static var Surveys = [
    ...
    {   
      ...
      NA_answerCode: null,
      DefaultPage: 'Results', // 1st page visible in report
      
      DimensionsForSurveysSchemaId: 7170,
      DimensionsForSurveysTable: 'Dimensions in pulse surveys', //table in DB Schema (setting above) which stores dimension ids used in a pulse survey
      ...
      Page_Results: {
        ...
        ScoreType: '%Fav' // %Fav, %Fav-%Unfav, AVG
      },
