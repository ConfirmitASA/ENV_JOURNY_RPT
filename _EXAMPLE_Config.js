...
public class Config {
    ...
    static const primaryRedColor = '#8B565A';
    ...
    static var ConditionalFormatting = {
        //Trend table
        set1: [
            {
                style: 'emptyCell'
        ...
        //Results table in Distribution mode
        set3: [
            {
                style: 'emptyCell'
            }, {
                style: 'cellLevel1',
                condition: '<55',
                conditionBody: '(col+12)<=cols && cellv(col+12,row)'
            }, {
                style: 'cellLevel2',
                condition: '<70',
                conditionBody: '(col+12)<=cols && cellv(col+12,row)'
    ...
    static const schemaId:int = null;   //8907;
    static const tableId:int = null;    //19882;
    static const relationId:int = null; //12044;
    ...
    static var Surveys = [
        ...
        //================================================================================
        {
            ...
            FiltersFromSurveyData: ['AgeGroup', 'SeniorityGroup', 'Country'], //not bg vars only, used in filter panel
            CompareQuestions: ['Country', 'Level2unitname'], // break-by questions used in the Compare section of the Filter Panel
            IsTimePeriodFilterHidden: false,
            HierarchyQuestion: null,
            ReportBaseQuestion: ['AgeGroup'], //will be eliminated from filter list if user has filter expression
            ...
            Page_KPI: {
                ...
                EnableCompareQuestionsSection: true // to add Compare section on Filter Panel with break by questions described in CompareBreakByQuestions survey property (above)
            },
            ...
            Page_Results: {
                ...
                CategorizationHelpQuestion: 'q1_1', // add here one question from one of Dimensions
                ...
                EnableCompareCombinedDistribution: true // to add Compare section on Filter Panel with filter questions described in CompareFilterQuestions survey property (above)
            },
