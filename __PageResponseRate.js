class PageResponseRate {
  ...
  /**
   * @memberof PageResponseRate
   * @function isCollectionPeriodVisible
   * @description function to show/hide the collection period for a survey
   * @param {Object} context - {pageContext: this.pageContext, report: report, user: user, state: state, confirmit: confirmit, log: log}
   * @return {Boolean}
   */

  static function isCollectionPeriodVisible (context) {
    return DataSourceUtil.getSurveyPropertyValueFromConfig (context, 'IsCollectionPeriodVisible');
  }
  ...
  static function ByTimeChart_Hide(context){
